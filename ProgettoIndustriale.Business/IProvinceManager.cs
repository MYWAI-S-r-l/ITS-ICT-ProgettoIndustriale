...
public interface IProvinceManager
{
    ...
    bool DeleteProvincia(string codice);

    bool DeleteProvince();

    Dto.Provincia? SaveProvincia(Dto.Provincia? provinciaToDelete);

    List<Dto.Provincia> SaveProvince(List<Dto.Provincia> provinceToSave);
